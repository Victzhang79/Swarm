...
# 本地模型名必须与服务器实际列表完全一致
SWARM_MODEL_ROUTING_TRIVIAL=laguna-s-2.1-fp8
SWARM_MODEL_ROUTING_TRIVIAL_FALLBACK=DeepSeek-V4-Flash-0731,Qwen3-Coder-Next-NVFP4-chat
SWARM_MODEL_ROUTING_MEDIUM=DeepSeek-V4-Flash-0731
SWARM_MODEL_ROUTING_MEDIUM_FALLBACK=GLM-5.2,Qwen3-Coder-Next-NVFP4-chat
SWARM_MODEL_ROUTING_COMPLEX=Qwen3.8-27B-TP2
SWARM_MODEL_WORKER_FALLBACK=GLM-5.2
SWARM_MODEL_ROUTING_COMPLEX_FALLBACK=DeepSeek-V4-Flash-0731,Qwen3-Coder-Next-NVFP4-chat,GLM-5.2
