...
# 本地模型名必须与服务器实际列表完全一致
SWARM_MODEL_ROUTING_TRIVIAL=ThinkingCap-Qwen3.6-27B
SWARM_MODEL_ROUTING_TRIVIAL_FALLBACK=MiniMax-M2.7-Pro,Qwopus3.6-27B-v2-NVFP4,stepfun-ai/Step-3.7-Flash-FP8
SWARM_MODEL_ROUTING_MEDIUM=MiniMax-M2.7-Pro
SWARM_MODEL_ROUTING_MEDIUM_FALLBACK=ThinkingCap-Qwen3.6-27B,Qwopus3.6-27B-v2-NVFP4,stepfun-ai/Step-3.7-Flash-FP8
SWARM_MODEL_ROUTING_COMPLEX=Qwopus3.6-27B-v2-NVFP4
SWARM_MODEL_ROUTING_COMPLEX_FALLBACK=ThinkingCap-Qwen3.6-27B,MiniMax-M2.7-Pro,stepfun-ai/Step-3.7-Flash-FP8
SWARM_MODEL_ROUTING_MULTIMODAL=ThinkingCap-Qwen3.6-27B
SWARM_MODEL_ROUTING_MULTIMODAL_FALLBACK=stepfun-ai/Step-3.7-Flash-FP8
