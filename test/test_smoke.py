...
def test_types():
    ...
    from swarm.types import (
        Complexity, TaskStatus, HumanDecision, FileScope,
        SubTask, TaskPlan, WorkerOutput, Confidence, MemoryLayer,
    )
...
def test_model_router():
    """测试模型路由"""
    from swarm.models.router import ModelRouter, SiliconFlowProvider, LocalProvider
...
def test_scope_guard():
    """测试 Scope Guard"""
    from swarm.tools.scope_guard import ScopeGuard, set_scope, get_scope, clear_scope
