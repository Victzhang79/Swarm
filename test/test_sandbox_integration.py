...
def test_1_sandbox_manager_basic():
    ...
    from swarm.worker.sandbox import SandboxManager, SandboxConfig
...
def test_2_code_result_parsing():
    ...
    from swarm.worker.sandbox import SandboxManager, CodeResult
...
def test_5_build_tools_sandbox_mode():
    ...
    from swarm.tools.build_tools import (
        ...
        _run, _run_local, _run_in_sandbox,
    )
...
def test_6_executor_sandbox_integration():
    ...
    from swarm.types import SubTask, FileScope
...
def test_8_smoke_reimport():
    ...
    # 专门验证 sandbox 相关导出
    from swarm.worker import SandboxManager, SandboxConfig, CodeResult, SandboxPool
    ...
    from swarm.tools.build_tools import set_sandbox_context, get_sandbox_context, clear_sandbox_context
