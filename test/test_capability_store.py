...
def test_current_model_fleet_capability_hints():
    assert cap.heuristic_context_window("Qwen3.8-27B-TP2", kind="local") == 393_216
    assert cap.heuristic_context_window("Qwen3.8-27B-NVFP4", kind="local") == 65_536
    assert cap.heuristic_context_window("DeepSeek-V4-Flash-0731", kind="local") == 1_048_576
    ...
    for model_id in (
        ...
        assert cap.heuristic_supports_multimodal(model_id) is True

    assert cap.heuristic_supports_multimodal("DeepSeek-V4-Flash-0731") is True
