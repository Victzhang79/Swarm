...
@app.post("/api/projects/{project_id}/memories/mistakes", tags=["记忆"])
...
@app.post("/api/projects/{project_id}/memories/mistakes/{mid}/dismiss", tags=["记忆"])
...
@app.delete("/api/projects/{project_id}/memories/mistakes/{mid}", tags=["记忆"])
...
@app.get("/api/projects/{project_id}/memories/successes", tags=["记忆"])
...
@app.post("/api/projects/{project_id}/memories/successes", tags=["记忆"])
...
@app.delete("/api/projects/{project_id}/memories/successes/{sid}", tags=["记忆"])
...
@app.get("/api/projects/{project_id}/memories/summaries", tags=["记忆"])
...
@app.post("/api/projects/{project_id}/memories/summaries", tags=["记忆"])
...
@app.put("/api/projects/{project_id}/memories/summaries/{sid}", tags=["记忆"])
...
@app.delete("/api/projects/{project_id}/memories/summaries/{sid}", tags=["记忆"])
...
@app.put("/api/projects/{project_id}/memories/profile", tags=["记忆"])
